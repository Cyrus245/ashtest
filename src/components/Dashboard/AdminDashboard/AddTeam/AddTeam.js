...
const AddTeam = ({ edit, setEdit, teams }) => {
  ...
  const onSubmit = (data) => {
    ...
    if (edit) {
      axios
        .put(
          `https://backend-ashinteriorbd-8a6e29b4adf0.herokuapp.com/api/team/v1/team/update/${edit}`,
          headerInfo
        )
        .then((res) => {
          toast.dismiss(loading);
          if (data.name === name && data.designation === designation) {
      ...
      axios
        .post(
          "https://backend-ashinteriorbd-8a6e29b4adf0.herokuapp.com/api/team/v1/team/add",
          headerInfo
        )
        .then((res) => {
          toast.dismiss(loading);
